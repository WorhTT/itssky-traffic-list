<template>
  <div class="app-container">
    <div
      ...
      <h3 style="font-weight: bolder;margin: 1vh 0">EEF_MTC电子支付通行费统计表</h3>
    </div>
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出EEF_MTC电子支付通行费统计表?', "警告", {
  ...
  `;
      ...
      <!DOCTYPE html>
        ...
        <body>
            ...
            <div class="print-title">EEF_MTC电子支付通行费统计表</div>
