...
export default {
  ...
  methods: {
    ...
    printTable() {
      ...
      printDocument.write('<div class="info-line"><span class="info-left">收费站：中心</span><span class="info-center">统计时间：2024-12-04</span><span class="info-right"></span></div>'); // Add the info line here // Add the info line here
