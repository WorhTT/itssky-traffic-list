...
import com.itssky.framework.config.properties.PermitAllUrlProperties;
import com.itssky.framework.security.filter.JwtAuthenticationTokenFilter;
import com.itssky.framework.security.handle.AuthenticationEntryPointImpl;
import com.itssky.framework.security.handle.LogoutSuccessHandlerImpl;
            ...
            .authorizeHttpRequests((requests) -> {
                ...
                requests.antMatchers("/login", "/register", "/captchaImage").permitAll()
                    ...
                    .antMatchers(HttpMethod.GET, "/", "/*.html", "/**/*.html", "/**/*.css", "/**/*.js", "/profile/**",
                        "/sso/client/token/handle").permitAll()
